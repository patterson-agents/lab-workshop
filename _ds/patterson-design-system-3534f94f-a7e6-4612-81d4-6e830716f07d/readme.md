...
Everything you copy to start something lives in **[`templates/`](templates)** — one directory, ten entries. Each is a self-contained folder: open its `index.html` (or `.dc.html`), replace the content, ship. They fall into two kinds.
